...
export MASTER=local[*]                      # port number to listen (default 8080)
...
export HBASE_HOME=/usr/local/HBase/                   # (require) Under which HBase scripts and configuration should be
export HBASE_CONF_DIR=/usr/local/HBase/conf/                # (optional) Alternatively, configuration directory can be set to point to the directory that has hbase-site.xml
